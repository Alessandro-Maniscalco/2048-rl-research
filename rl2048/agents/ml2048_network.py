# Adapted from tsangwpx/ml2048, MIT license. See ML2048_LICENSE.txt.
# Exact upstream network definitions; checkpoint provenance in research/pretrained_sources/ml2048.
import math
...
class CNNEncoder(nn.Module):
    ...
    def forward(self, x: torch.LongTensor) -> torch.FloatTensor:
        ...
        # -> (N, NUM_CLASSES, 4, 4)
        board = torch.reshape(x, (-1, self.num_classes, 4, 4))
